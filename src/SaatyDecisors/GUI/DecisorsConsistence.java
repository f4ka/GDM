...
public class DecisorsConsistence {
    ...
    public void calculateSum(){
        ...
        for(i=0; i<n; i++)
            for(j=0; j<n; j++)
                sumCols[j]=sumCols[j]+StructursDecisors.A[i][j];
    }
    ...
    public void createMatriXA1(){
        for(i=0; i<n; i++)
            for(j=0; j<n; j++)
                A1[i][j]=StructursDecisors.A[i][j]/sumCols[j];
    }
    ...
    public void createEigenvector(){
        ...
        for(i=0; i<n; i++)
            StructursDecisors.eigenvector.add(eigenvector[i]);
    }
    }
    //////////////////////////////////////////////////////////////////////////////////////////////////////
    public class IC{
    ...
    public double[] calculateAW(){
        ...
        for(i=0; i<n; i++){
            k=0;
            for(j=0; j<n; j++){
                AW[i]=AW[i]+StructursDecisors.A[i][j]*eigenvector[k];
                k++;
            }
        }
        return AW;
    ...
    public class RI{
        public double calculateRI(){
            IC ic=new IC();
            double RI=ic.calculateIC()/StructursDecisors.CA[n-1];
            return RI;
        }
    }
